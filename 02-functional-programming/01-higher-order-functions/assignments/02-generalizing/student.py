...
# print(count_movies_from_year(movies, 2014))
...
def select_movies_with_actor(movies, actor):
    ...
    for movie in movies:
        if actor in movie.actors:
            ...
            # result_movies.append(movie.title)
...
# print(sum_movie_duration_from_period(movies, 1990, 2000))

def get_directors_for_actor(movies, actor):
    directors = []
    for movie in movies:
        if actor in movie.actors:
...
# print(get_directors_for_actor(movies, "Leonardo Dicaprio"))
...
# print(find_string_starting_with(strings, "a"))
...
# print(find_number_greater_than(numbers, 100))